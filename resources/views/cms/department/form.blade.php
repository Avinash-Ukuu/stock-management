            ...
            {{Form::model($object,['url'=>$url,'method'=>$method,'onSubmit'=>"document.getElementById('submit').disabled=true;"])}}
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {{Form::label("head_id","Select Head",[])}}<span style="color: red;"> *</span>
                        {{Form::select("head_id",$users, null, ['class'=>'form-control select2','placeholder'=>'Select Head','data-placeholder'=>'Select Head','required'])}}
                    </div>
                    <div class="form-group">
