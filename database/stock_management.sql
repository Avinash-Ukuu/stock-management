...
/*Table structure for table `stock_condition_logs` */

DROP TABLE IF EXISTS `stock_condition_logs`;

CREATE TABLE `stock_condition_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stock_id` int(11) DEFAULT NULL,
  `stock_usage_id` int(11) DEFAULT NULL,
...
/*Data for the table `stock_condition_logs` */
